...
const targetInfo = [
  {
    ...
    ,funcName:["getStoremanGroupInfo", "getStoremanGroupInfoVVVVV"]
    ,inputTypes:["bytes32"]
  ...
  ,{
    ...
    ,funcName:["getEthBalance1","getEthBalance","getBalance"]
    ,inputTypes:["address"]
    ,outputTypes:["uint256"]
    ,outputNames:["balance"]
...
async function test() {
    ...
    const result = await multiCall(client, {multiCallAddr: process.env.testnetWanMultiCallAddr, targetInfo}, "ethMultiCall", "tryBlockAndAggregate");
